...
### Option B: Using npx (Recommended for Node.js)
As per the official [n8n npm documentation](https://docs.n8n.io/hosting/installation/npm/), you can run n8n without installing it globally:
```bash
npx n8n
```
*Note: This will download and run the latest version of n8n.*

### Option C: Direct Global Install
```bash
npm install -g n8n
n8n start
```
